    ...
    <div>
        ...
        <Dialog v-model:visible="productDialog" :style="{width: '450px'}" header="Product Details" :modal="true" class="p-fluid">
            ...
            <div class="field">
                ...
                <div class="formgrid grid">
                    <div class="field-radiobutton col-6">
                        <RadioButton id="category1" name="category" value="Nike" v-model="product.category" />
                        <label for="category1">Nike</label>
                    </div>
                    <div class="field-radiobutton col-6">
                        <RadioButton id="category2" name="category" value="Adidas" v-model="product.category" />
                        <label for="category2">Adidas</label>
                    </div>
                    <div class="field-radiobutton col-6">
                        <RadioButton id="category3" name="category" value="Converse" v-model="product.category" />
                        <label for="category3">Converse</label>
                    </div>
                    <div class="field-radiobutton col-6">
                        <RadioButton id="category4" name="category" value="New Balance" v-model="product.category" />
                        <label for="category4">New Balance</label>
                    </div>
                    <div class="field-radiobutton col-6">
                        <RadioButton id="category4" name="category" value="Puma" v-model="product.category" />
                        <label for="category4">Puma</label>
                    </div>
                    <div class="field-radiobutton col-6">
                        <RadioButton id="category4" name="category" value="Reebok" v-model="product.category" />
